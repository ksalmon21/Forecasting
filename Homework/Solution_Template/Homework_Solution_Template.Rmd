...
- Whenever appropriate, please refer to the output. Please take a look at the `.Rmd` [here](.../Homework/Solution_Template/Homework_Solution_Template.Rmd) to see how I am able to (i) Add captions to my plots, (ii) hyperlink and reference the plots, and (iii) embed the results stored in the R chunks into my text.
